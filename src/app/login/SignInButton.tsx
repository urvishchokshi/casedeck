...
export function SignInButton() {
  ...
  return (
    <button
      ...
      onClick={signIn}
      disabled={loading}
      className="mt-[38px] flex h-14 items-center gap-[11px] whitespace-nowrap rounded-[14px] bg-[var(--accent)] px-[30px] text-[15px] font-semibold text-[var(--on-accent)] transition-[color,background-color,opacity,transform] enabled:active:scale-[0.97] [box-shadow:var(--sh-cta)] hover:bg-[var(--landing-cta-hover)] disabled:cursor-not-allowed disabled:opacity-60"
    >
